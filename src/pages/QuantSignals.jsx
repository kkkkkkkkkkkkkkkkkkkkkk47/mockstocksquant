import { Zap, TrendingUp, Shield, Award, BarChart2 } from "lucide-react";
...
export default function QuantSignals() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl md:text-2xl font-bold" style={{ color: "#F9FAFB" }}>Quant Signals</h1>
        <p className="text-xs md:text-sm mt-1" style={{ color: "#9CA3AF" }}>
          AI-powered quantitative analysis across momentum, value, quality, and risk
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          >
            ...
            <div
              className="text-xl md:text-2xl font-black px-2 py-1 rounded-lg inline-block"
      ...
      {/* Signal Cards — 1 col mobile, 2 md, 3 xl */}
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs mt-0.5" style={{ color: "#9CA3AF" }}>Score</div>
                </div>
              </div>
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-center gap-1 justify-end mt-0.5">
                    <div className="w-12 h-1.5 rounded-full overflow-hidden" style={{ background: "#1F2937" }}>
                      <div className="h-full rounded-full" style={{ width: `${s.confidence}%`, background: "#3B82F6" }} />
                    </div>
